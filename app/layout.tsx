...
import { QueryProvider } from '@/app/_shared/components/providers/QueryProvider';
...
export const metadata: Metadata = {
  ...
  description:
    'A production-ready Next.js template with authentication, form validation, theming, and scalable architecture.',
