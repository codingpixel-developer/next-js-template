...
**Read this when:** setting up new pages/routes, understanding folder structure, configuring Next.js, adding new path aliases, or navigating the codebase for the first time.
